...
export function TripStrip() {
  ...
  return (
    <section className="trip-strip">
      ...
      <p className="trip-provenance">Times and fares are curated estimates as of {formatDateOnly(city.snapshot.curatedAt)}, not live directions.</p>
    </section>
  );
}
